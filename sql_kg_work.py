...
output_file_date='sql_kg_gemma3_date.json'
output_file_date_summary= 'sql_kg_gemma3_date_summary.json'

input_file_name='/home/NingyuanXiao/Vanna_test/user_queries_sql_kg.txt'
output_file_name='sql_kg_gemma3_name.json'
output_file_name_summary='sql_kg_gemma3_name_summary.json'

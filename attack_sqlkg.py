...
input_file_date='/home/NingyuanXiao/multi-agents/attack/wrong_answer_deepseek.json'
output_file_date='attack_sql_kg_deepseek_date.json'
output_file_date_summary= 'attack_sql_kg_deepseek_date_summary.json'

input_file_name='/home/NingyuanXiao/multi-agents/attack/wrong_answer_deepseek.json'
output_file_name='attack_sql_kg_deepseek_name.json'
output_file_name_summary='attack_sql_kg_deepseek_name_summary.json'

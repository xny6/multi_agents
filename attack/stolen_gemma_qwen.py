...
WORKING_DIR = "/home/NingyuanXiao/multi-agents/working_dir_for_gemma3_qwen"
...
def configure_logging():
    ...
    log_file_path = os.path.abspath(os.path.join(log_dir, "/home/NingyuanXiao/multi-agents/log_for_gemma3_qwen.log"))
...
async def main():
    try:
        ...
        # 写入到json文件
        with open('stolen_data_gemma_qwen.json', 'w', encoding='utf-8') as out_f:

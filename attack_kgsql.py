import json
import re
from functions import generate_sql_query, generate_kg_query, summary_response, process_kg_sql, generate_wrong_answers,generate_new_wrong_answers
import asyncio
...
#         adversarial_content = item.get("new_wrong_answer", "")
